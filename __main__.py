from analisisTools.researchData import TNSE, drawSemple, k_means, tree, drawDinamo, elbow_method_k_means
...
if __name__ == "__main__":
    ...
    # elbow_method_k_means(sample.copy(True), 10)
    ...
    #
    # drawDinamo(sample_1.loc[4])
    # drawDinamo(sample_2.loc[4])
